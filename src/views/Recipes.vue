<template>
    <div>
        <div>
            ...
            <input type="search" id="filter-title" v-model="filtersTitle">
            ...
            <div>
                Nombre de personne entre <input type="number" name="X" min="0" v-model="filtersPersonMin"> et <input type="number" name="Y" min="0" v-model="filtersPersonMax">
            </div>
